...
void js_initialize_listing() {
    listing_lhs_width        = LISTING_LHS_WIDTH;
    listing_lhs_width_second = LISTING_LHS_WIDTH_SECOND;
    listing_lhs_cont_lines   = LISTING_LHS_CONT_LINES;
    listing_rhs_width        = LISTING_RHS_WIDTH;
    listing_tail = 0;
    file_info_head = 0;
    last_open_file_info = 0;
    last_open_file = 0;
    head = 0;
    paper_width = 200;
    paper_height = 60;
